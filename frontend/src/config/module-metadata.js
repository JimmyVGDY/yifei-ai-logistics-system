...
export const operationLogTableColumns = columns('operation_time:操作时间,operation_status:状态,operation_source:操作来源,executor_type:执行者,operation:操作内容,ai_tool_name:AI工具,ai_tool_target:AI目标,username:操作人,user_code:用户编号,request_method:方法,request_uri:请求地址,cost_ms:耗时ms,trace_id:Trace ID,login_session_id:会话ID')
